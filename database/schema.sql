...
(1, 'Sector 1: Front Lawn', 'yard', TRUE, TRUE, 'secondary'),
(2, 'Sector 2: Flower Beds', 'local_florist', FALSE, TRUE, 'primary'),
(3, 'Sector 3: Veggie Patch', 'potted_plant', FALSE, TRUE, 'primary'),
(4, 'Sector 4: Backyard', 'grass', TRUE, FALSE, 'secondary');
